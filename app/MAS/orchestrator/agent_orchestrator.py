...
2. Если задача уже решена на основе истории — выбери FINISH.
3. Если нужен анализ структуры молекулы — выбери StructureAnalyzer.
4. Если нужен анализ продуктов реакции в смеси — выбери MixtureReactionAgent.
